...
export const navItems: NavEntry[] = [
  ...
  // 2. CMDB
  {
    ...
    children: [
      ...
      { href: '/cmdb/spatial', label: '机房视图', icon: Map, resource: 'cmdb_spatial', action: 'read' },
      { href: '/cmdb/changes', label: '变更记录', icon: History, resource: 'cmdb_change', action: 'read' },
      { href: '/cmdb/instances/2d-view', label: '拓扑（待上线）', icon: Grid3x3, resource: 'cmdb_instance', action: 'read' },
      { href: '/cmdb/alerts', label: '告警中心（待上线）', icon: Bell, resource: 'cmdb_alert', action: 'read', badgeKey: 'alerts' },
    ],
  },
  ...
  // 3. 变更文档
  {
    ...
    defaultOpen: false,
    children: [
      { href: '/change-docs', label: '文档列表', icon: FileText, resource: 'change_doc', action: 'read', badgeKey: 'changeDocs', exact: true },
  ...
  // 5. 资源与文档中心
  {
    ...
    children: [
      ...
      { href: '/wiki', label: '知识库', icon: BookOpen, resource: 'wiki', action: 'read' },
    ],
  },
