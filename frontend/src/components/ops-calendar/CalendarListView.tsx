  ...
  return (
    <Table
      ...
      rows={items.map((item) => ({
        ...
        cells: {
          title: item.title,
          itemType: <StatusBadge label={calendarItemTypeLabel(item.itemType)} status="neutral" />,
      ...
      empty={<EmptyState title="暂无日历事项" description="当前筛选范围内没有任务、排班或节假日。" showAction={false} />}
      onRowClick={(id) => {
