...
/** 模块根面包屑（带侧栏同款图标，宝蓝高亮）。无落地页的分组不带 href；任务中心落地到任务列表，身份与权限落地到用户管理，资源管理落地到设备密码库，流程中心落地到流程实例，报表分析落地到任务统计，系统管理落地到系统配置。 */
const ROOT = {
  ...
  workflow: { label: '流程中心', href: '/workflow/instances', icon: GitBranch },
  reports: { label: '报表分析', href: '/tasks/analytics', icon: BarChart2 },
  identity: { label: '身份与权限', href: '/users', icon: Shield },
  account: { label: '账号' },
  system: { label: '系统管理', href: '/admin/config', icon: Settings },
...
const ROUTES: RouteDef[] = [
  ...
  { pattern: '/cmdb/spatial/rooms/:id/edit', trail: [ROOT.cmdb, { label: '空间布局', href: '/cmdb/spatial' }, { label: '布局编辑' }] },
  { pattern: '/cmdb/spatial/rooms/:id/versions', trail: [ROOT.cmdb, { label: '空间布局', href: '/cmdb/spatial' }, { label: '版本历史' }] },
  { pattern: '/cmdb/spatial/rooms/:id', trail: [ROOT.cmdb, { label: '空间布局', href: '/cmdb/spatial' }, { label: '机房布局' }] },
  { pattern: '/cmdb/spatial/spike', trail: [ROOT.cmdb, { label: '空间布局', href: '/cmdb/spatial' }, { label: '画布验证' }] },
  { pattern: '/cmdb/spatial', trail: [ROOT.cmdb, { label: '空间布局' }] },
  ...
  { pattern: '/cmdb/topology/:id/compare', trail: [ROOT.cmdb, { label: '实例浏览', href: '/cmdb' }, { ...DYN }, { label: '拓扑对比' }] },
  { pattern: '/cmdb/topology/:id', trail: [ROOT.cmdb, { label: '实例浏览', href: '/cmdb' }, { ...DYN }, { label: '拓扑图' }] },
  { pattern: '/cmdb/impact/:id', trail: [ROOT.cmdb, { label: '实例浏览', href: '/cmdb' }, { ...DYN }, { label: '影响分析' }] },
  ...
  { pattern: '/tasks/templates', trail: [ROOT.task, { label: '任务模板' }] },
  { pattern: '/tasks/plans/new', trail: [ROOT.task, { label: '任务计划', href: '/tasks/plans' }, { label: '新建计划' }] },
  { pattern: '/tasks/plans/:id', trail: [ROOT.task, { label: '任务计划', href: '/tasks/plans' }, { ...DYN }] },
  { pattern: '/tasks/plans', trail: [ROOT.task, { label: '任务计划' }] },
  { pattern: '/tasks/analytics/:id', trail: [ROOT.task, { label: '任务统计', href: '/tasks/analytics' }, { ...DYN }] },
  { pattern: '/tasks/analytics', trail: [ROOT.task, { label: '任务统计' }] },
  { pattern: '/tasks/metrics', trail: [ROOT.task, { label: '指标与目标' }] },
  { pattern: '/tasks/automations', trail: [ROOT.task, { label: '任务自动化' }] },
  { pattern: '/tasks/:id', trail: [ROOT.task, { label: '任务列表', href: '/tasks' }, { ...DYN }] },
  { pattern: '/tasks', trail: [ROOT.task, { label: '任务列表' }] },
