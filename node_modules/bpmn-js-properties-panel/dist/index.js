...
const PanelHeaderProvider = translate => {
  ...
  return {
    ...
    getElementIcon: element => {
      ...
      const templateIcon = ModelUtil.getBusinessObject(element).get(iconProperty);
      if (templateIcon) {
...
function BpmnPropertiesPanel(props) {
  ...
  return jsxRuntime.jsx(BpmnPropertiesPanelContext.Provider, {
    ...
    children: jsxRuntime.jsx(propertiesPanel.FeelLanguageContext.Provider, {
      value: DEFAULT_FEEL_LANGUAGE_CONTEXT,
...
function nextId(prefix) {
  const ids$1 = new ids.Ids([32, 32, 1]);
  return ids$1.nextPrefixed(prefix);
}
...
function AdHocCompletionProps$1(props) {
  ...
  if (!ModelUtil.is(element, 'bpmn:AdHocSubProcess')) {
    return [];
  }
  return [{
...
function CompletionCondition$3(props) {
  ...
  const getValue = () => {
    const expression = ModelUtil.getBusinessObject(element).get('completionCondition');
    return expression && expression.get('body');
  };
  const setValue = value => {
    return createOrUpdateFormalExpression(element, ModelUtil.getBusinessObject(element), 'completionCondition', value, bpmnFactory, commandStack);
  };
...
function isErrorSupported(element) {
  return ModelingUtil.isAny(element, ['bpmn:StartEvent', 'bpmn:BoundaryEvent', 'bpmn:EndEvent']) && !!getErrorEventDefinition$1(element);
}
...
function isCompensationSupported(element) {
  return ModelingUtil.isAny(element, ['bpmn:EndEvent', 'bpmn:IntermediateThrowEvent']) && !!getCompensateEventDefinition$1(element);
}
...
function ExecutableProps(props) {
  ...
  if (!ModelUtil.is(element, 'bpmn:Process') && !hasProcessRef$2(element)) {
    return [];
  }
  return [{
    id: 'isExecutable',
...
function Id$4(props) {
  ...
  const getValue = hooks.useCallback(element => {
    return ModelUtil.getBusinessObject(element).id;
  }, [element]);
...
function getConditionalEventDefinition$1(element) {
...
const OPTIONAL_JOB_WORKER_ELEMENTS = ['bpmn:AdHocSubProcess', 'bpmn:BusinessRuleTask', 'bpmn:ScriptTask'];
function isZeebeServiceTask(element) {
  ...
  if (ModelUtil.isAny(element, OPTIONAL_JOB_WORKER_ELEMENTS) && !getTaskDefinition$4(element)) {
    return false;
  }
  return true;
}
...
const BpmnFeelEntry = withVariableContext(withTooltipContainer(propertiesPanel.FeelEntry));

function ActiveElementsProps(props) {
  const {
    element
  } = props;
  if (!ModelUtil.is(element, 'bpmn:AdHocSubProcess') || isZeebeServiceTask(element)) {
    return [];
  }
  const entries = [{
...
function getProperty$2(element) {
  const extensionElement = getExtensionElement$1(element);
...
function getExtensionElement$1(element) {
  const businessObject = ModelUtil.getBusinessObject(element);
...
const BPMN_IMPLEMENTATION_OPTION = 'bpmn',
  JOB_WORKER_IMPLEMENTATION_OPTION$3 = 'jobWorker';
function AdHocSubProcessImplementationProps(props) {
  const {
    element
  } = props;
  if (!ModelUtil.is(element, 'bpmn:AdHocSubProcess')) {
...
function AdHocImplementation(props) {
  ...
  const getValue = () => {
    if (getTaskDefinition$3(element)) {
      return JOB_WORKER_IMPLEMENTATION_OPTION$3;
    }
   ...
   */
  const setValue = value => {
    if (value === JOB_WORKER_IMPLEMENTATION_OPTION$3) {
  ...
  const getOptions = () => {
    const options = [{
      value: BPMN_IMPLEMENTATION_OPTION,
      label: translate('BPMN')
    }, {
      value: JOB_WORKER_IMPLEMENTATION_OPTION$3,
...
function createTaskDefinition(element, bpmnFactory, commandStack) {
  const businessObject = ModelUtil.getBusinessObject(element);
  const taskDefinition = createElement('zeebe:TaskDefinition', {}, null, bpmnFactory);
...
function removeTaskDefinition(element, commandStack) {
  const taskDefinition = getTaskDefinition$3(element);
  if (taskDefinition) {
    removeExtensionElements(element, ModelUtil.getBusinessObject(element), taskDefinition, commandStack);
  }
}
...
function getCondition(element) {
  ...
  if (ModelUtil.is(businessObject, 'bpmn:Event')) {
    const conditionalEventDefinition = getConditionalEventDefinition$1(businessObject);
 ...
 * @param {BpmnFactory} bpmnFactory
 */
function setConditionalEventConditionBody(element, value, commandStack, bpmnFactory) {
  const conditionalEventDefinition = getConditionalEventDefinition$1(element);
    ...
    return commandStack.execute('element.updateModdleProperties', {
      ...
      properties: {
        condition: createElement('bpmn:FormalExpression', {
          body: value
        }, conditionalEventDefinition, bpmnFactory)
      }
    });
  }
  commandStack.execute('element.updateModdleProperties', {
 ...
 */
function EventConditionProps(props) {
  const {
    element
  } = props;
  if (!getConditionalEventDefinition$1(element)) {
    return [];
  }
  const entries = [{
    id: 'condition',
  ...
  if (ModelUtil.is(element.parent, 'bpmn:SubProcess') || ModelUtil.is(element, 'bpmn:IntermediateCatchEvent') || ModelUtil.is(element, 'bpmn:BoundaryEvent')) {
    entries.push({
      id: 'variableEvents',
      component: VariableEvents$1
    });
  }
  return entries;
}
 ...
 */
function VariableEvents$1(props) {
  const {
    element
  } = props;
  ...
  const setValue = values => {
    ...
    setConditionalFilter(element, {
      variableEvents
    }, bpmnFactory, commandStack);
  };
  return propertiesPanel.CheckboxGroup({
    element,
    id: 'variableEvents',
    options: [{
      label: translate('Create'),
      value: VARIABLE_EVENTS.CREATE
    }, {
      label: translate('Update'),
      value: VARIABLE_EVENTS.UPDATE
    }],
    getValue,
    setValue,
...
function setConditionalFilter(element, properties, bpmnFactory, commandStack) {
  ...
  if (!conditionalFilter) {
    conditionalFilter = createElement('zeebe:ConditionalFilter', {}, conditionalEventDefinition, bpmnFactory);
    ...
    extensionElementsValues = [...extensionElementsValues, conditionalFilter];
    const updatedExtensionElements = createElement('bpmn:ExtensionElements', {
 ...
 */
function ExecutionListenerHeaders(props) {
  const {
    id,
    element,
    listener
  ...
  function removeHeader(header) {
    ...
    const newHeaders = minDash.without(taskHeaders.get('values'), header);
...
const MI_EVENT_TO_LABEL = {
  'beforeAll': 'Before all',
  'start': 'Before each',
  'end': 'After each'
};
function getEventLabel(element, eventType) {
  const labels = isMultiInstance(element) ? MI_EVENT_TO_LABEL : EVENT_TO_LABEL$2;
...
function getEventTypes(element) {
  if (ModelUtil.isAny(element, ['bpmn:BoundaryEvent', 'bpmn:StartEvent'])) {
    return ['end'];
  }
  if (ModelUtil.is(element, 'bpmn:EndEvent') && getErrorEventDefinition(element)) {
    return ['start'];
  }
  if (ModelUtil.is(element, 'bpmn:Gateway')) {
    return ['start'];
  }
  if (isMultiInstance(element)) {
    return ['beforeAll', 'start', 'end'];
  }
  if (ModelUtil.isAny(element, ['bpmn:Process', 'bpmn:Participant'])) {
    return ['start', 'end', 'cancel'];
  }
  return ['start', 'end'];
}
function isMultiInstance(element) {
  const loopCharacteristics = ModelUtil.getBusinessObject(element).get('loopCharacteristics');
  return !!loopCharacteristics && ModelUtil.is(loopCharacteristics, 'bpmn:MultiInstanceLoopCharacteristics');
}
...
function ExecutionListenersProps({
  ...
  const items = listeners.map((listener, index) => {
    ...
    return {
      id,
      label: translate(`${getEventLabel(element, listener.get('eventType'))}: {type}`, {
        type
      }),
...
function removeFactory$e({
  ...
  return function (event) {
    ...
    const listeners = minDash.without(container.get('listeners'), listener);
...
function canHaveExecutionListeners(bo, moddle) {
  ...
  if (!ModelUtil.isAny(bo, executionListenersDescriptor.meta.allowedIn)) {
    return false;
  }
...
function isCompensationBoundaryEvent(bo) {
  return ModelUtil.is(bo, 'bpmn:BoundaryEvent') && getCompensateEventDefinition(bo);
}
...
function isFormSupported$1(element) {
  if (ModelUtil.is(element, 'bpmn:UserTask')) {
    return true;
  }
  if (ModelUtil.is(element, 'bpmn:StartEvent')) {
    ...
    if (!ModelUtil.is(parent, 'bpmn:Process')) {
      return false;
    }
    return true;
  }
...
function getFormType$1(element) {
  ...
  if (minDash.isDefined(externalReference)) {
...
function FormProps$1(props) {
  ...
  if (!isFormSupported$1(element)) {
    return [];
  }
  const isStartEvent = ModelUtil.is(element, 'bpmn:StartEvent');
...
function ExternalReference(props) {
  ...
  const setValue = value => {
    setExternalReference(injector, element, minDash.isUndefined(value) ? '' : value);
  };
  return BpmnFeelEntry({
    element,
    id: 'externalReference',
...
function areOutputParametersSupported$1(element) {
  if (ModelUtil.is(element, 'bpmn:EndEvent') && (getErrorEventDefinition$1(element) || getTerminateEventDefinition(element))) {
    return false;
  }
  if (ModelUtil.is(element, 'bpmn:CallActivity')) {
    return !isPropagateAllChildVariables(element);
  }
  return ModelingUtil.isAny(element, ['zeebe:ZeebeServiceTask', 'bpmn:UserTask', 'bpmn:SubProcess', 'bpmn:ReceiveTask', 'bpmn:Event', 'bpmn:BusinessRuleTask']);
}
...
function InputProps$1({
  ...
  const items = inputParameters.map((parameter, index) => {
    ...
    return {
      id,
      label: parameter.get('target') ? jsxRuntime.jsx("code", {
        children: parameter.get('target')
      }) : '',
...
function MultiInstanceProps$1(props) {
  ...
  return [{
    ...
    component: OutputCollection$1,
    isEdited: propertiesPanel.isTextFieldEntryEdited
  }, {
    id: 'multiInstance-outputElement',
    component: OutputElement$1,
    isEdited: propertiesPanel.isFeelEntryEdited
  }, {
...
function OutputCollection$1(props) {
  const {
    element
  } = props;
  const commandStack = useService('commandStack');
...
function OutputElement$1(props) {
  const {
    element
  } = props;
  const commandStack = useService('commandStack');
...
function OutputCollectionProps(props) {
  const {
    element
  } = props;
  if (!ModelUtil.is(element, 'bpmn:AdHocSubProcess')) {
...
function isZeebeUserTask(element) {
  const businessObject = ModelUtil.getBusinessObject(element);
  return ModelUtil.is(element, 'bpmn:UserTask') && !!getExtensionElementsList(businessObject, 'zeebe:UserTask')[0];
}
...
const EVENT_TYPE = ['creating', 'assigning', 'updating', 'completing', 'canceling'];
...
function canHaveTaskListeners(bo, moddle) {
  ...
  return ModelUtil.isAny(bo, TaskListenersDescriptor.meta.allowedIn);
}
...
function removeZeebeUserTask(element, commandStack) {
  ...
  removeExtensionElements(element, ModelUtil.getBusinessObject(element), zeebeUserTask, commandStack);
}
...
const ZEEBE_GROUPS = [BusinessRuleImplementationGroup, CalledDecisionGroup, ScriptImplementationGroup, ScriptGroup$1, OutputCollectionGroup, AdHocSubProcessImplementationGroup, UserTaskImplementationGroup, TaskDefinitionGroup, AssignmentDefinitionGroup, ActiveElementsGroup, FormGroup$1, ConditionGroup$1, EventConditionGroup, TargetGroup, InputPropagationGroup, InputGroup$1, OutputPropagationGroup, OutputGroup$1, HeaderGroup, TaskListenersGroup, ExecutionListenersGroup, ExtensionPropertiesGroup$1];
...
function AdHocSubProcessImplementationGroup(element, injector) {
  ...
  const group = {
    ...
    label: translate('Implementation'),
    entries: [...AdHocSubProcessImplementationProps({
      element
    })],
    component: propertiesPanel.Group
  };
...
function InMappingProps({
  ...
  const items = variableMappings.map((mapping, index) => {
    ...
    return {
      id,
      label: mapping.get('target') ? jsxRuntime.jsx("code", {
        children: mapping.get('target')
      }) : '',
...
function Id(props) {
  ...
  const description = ModelUtil.is(element, 'bpmn:Process') ? translate('This maps to the process definition key.') : null;
  return propertiesPanel.TextFieldEntry({
    element,
    id: 'id',
    label: translate(ModelUtil.is(element, 'bpmn:Participant') ? 'Participant ID' : 'ID'),
...
function ProcessId(props) {
  ...
  const description = ModelUtil.is(element, 'bpmn:Participant') ? translate('This maps to the process definition key.') : null;
  return propertiesPanel.TextFieldEntry({
    element,
    id: 'processId',
    label: translate('Process ID'),
...
function updateGeneralGroup(groups, element) {
  ...
  const processIdIndex = minDash.findIndex(entries, entry => entry.id === 'processId');
...
function moveGroup(groups, id, position) {
  ...
  return arrayMove.arrayMoveMutable(groups, groupIndex, position);
}
...
const TooltipProvider$1 = {
  'group-assignmentDefinition': element => {
    const translate = useService('translate');
    return jsxRuntime.jsxs("div", {
      children: [translate('Define the assignment, schedule, and priority of the user task. Assignee, candidate groups, and candidate users can be combined. Use due date and follow-up date to express deadlines and urgency. '), jsxRuntime.jsx("a", {
  ...
  'group-condition': element => {
    const translate = useService('translate');
    return jsxRuntime.jsxs("div", {
      children: [translate('Define a boolean condition expression that determines when this sequence flow is taken. '), jsxRuntime.jsx("a", {
  ...
  'group-businessRuleImplementation': element => {
    const translate = useService('translate');
    return jsxRuntime.jsxs("div", {
      children: [translate('Evaluate a business rule, for example a DMN decision. To add a custom implementation, use a job worker. '), jsxRuntime.jsx("a", {
  ...
  'group-userTaskImplementation': element => {
    const translate = useService('translate');
    return jsxRuntime.jsxs("div", {
      children: [translate('Implement a user task managed by Camunda. To add a custom implementation, use a job worker. '), jsxRuntime.jsx("a", {
  ...
  'group-form': element => {
    ...
    if (ModelUtil.is(element, 'bpmn:StartEvent')) {
      return jsxRuntime.jsxs("div", {
        children: [translate('Link a form created with the Camunda Forms editor. Submitting this form will start a new process instance. '), jsxRuntime.jsx("a", {
          href: "https://docs.camunda.io/docs/components/modeler/forms/utilizing-forms/#connect-your-form-to-a-bpmn-diagram",
          target: "_blank",
          rel: "noopener noreferrer",
          title: translate('Start event form documentation'),
          children: translate('Learn more.')
        })]
      });
    }
    if (isZeebeUserTask$1(element)) {
      return jsxRuntime.jsxs("div", {
        children: [translate('Link a form created with the Camunda Forms editor. To associate a custom form, application, or URL to the user task, specify an external reference. '), jsxRuntime.jsx("a", {
          href: "https://docs.camunda.io/docs/components/modeler/forms/utilizing-forms/#connect-your-form-to-a-bpmn-diagram",
          target: "_blank",
          rel: "noopener noreferrer",
  ...
  'group-calledDecision': element => {
    const translate = useService('translate');
    return jsxRuntime.jsxs("div", {
      children: [translate('Define the decision to evaluate and how to map back the evaluation result. '), jsxRuntime.jsx("a", {
        href: "https://docs.camunda.io/docs/components/modeler/bpmn/business-rule-tasks/#defining-a-called-decision",
        target: "_blank",
        rel: "noopener noreferrer",
        title: translate('Called decision documentation'),
        children: translate('Learn more.')
      })]
    });
  },
  'group-message': element => {
    ...
    if (ModelUtil.is(element, 'bpmn:ReceiveTask')) {
      return jsxRuntime.jsxs("div", {
        children: [translate('Configure the message that the task waits for. '), jsxRuntime.jsx("a", {
    ...
    if (ModelUtil.is(element, 'bpmn:StartEvent')) {
      return jsxRuntime.jsxs("div", {
        children: [translate('Configure the message that will start this process instance. '), jsxRuntime.jsx("a", {
    ...
    if (ModelUtil.is(element, 'bpmn:IntermediateCatchEvent')) {
      return jsxRuntime.jsxs("div", {
        children: [translate('Configure the message that this event waits for. '), jsxRuntime.jsx("a", {
    ...
    if (ModelUtil.is(element, 'bpmn:BoundaryEvent')) {
      return jsxRuntime.jsxs("div", {
        children: [translate('Configure the message that will trigger this boundary event. '), jsxRuntime.jsx("a", {
  ...
  'group-error': element => {
    const translate = useService('translate');
    if (ModelUtil.is(element, 'bpmn:EndEvent')) {
      return jsxRuntime.jsxs("div", {
        children: [translate('Define the error to throw. Specify an error code (e.g. '), jsxRuntime.jsx("code", {
          children: "order-not-found"
        }), translate(') to identify the error. '), jsxRuntime.jsx("a", {
    ...
    return jsxRuntime.jsxs("div", {
      children: [translate('Define the error to catch. Specify an error code (e.g. '), jsxRuntime.jsx("code", {
        children: "order-not-found"
      }), translate(') to match a specific error, or leave empty to catch any error. '), jsxRuntime.jsx("a", {
        href: "https://docs.camunda.io/docs/components/modeler/bpmn/error-events/#defining-the-error",
        target: "_blank",
        rel: "noopener noreferrer",
        title: translate('Error event documentation'),
  ...
  'group-inputs': element => {
    const translate = useService('translate');
    return jsxRuntime.jsxs("div", {
      children: [translate('Add input mappings to control what is passed to the activity as local variables. '), jsxRuntime.jsx("a", {
  ...
  'group-outputs': element => {
    const translate = useService('translate');
    return jsxRuntime.jsxs("div", {
      children: [translate('Add output mappings to control which variables are merged back into the process scope. '), jsxRuntime.jsx("a", {
  ...
  'taskDefinitionRetries': element => {
    ...
    return jsxRuntime.jsx("div", {
      children: jsxRuntime.jsxs("p", {
        children: [translate('The number of times the engine tries executing this activity if a worker signals a failure. The default is three.'), " ", ' ', jsxRuntime.jsx("a", {
          href: "https://docs.camunda.io/docs/components/best-practices/development/dealing-with-problems-and-exceptions/#leveraging-retries",
          target: "_blank",
          rel: "noopener noreferrer",
          children: translate('Learn more.')
        })]
  ...
  'priorityDefinitionPriority': element => {
    ...
    return jsxRuntime.jsx("div", {
      children: jsxRuntime.jsxs("p", {
        children: [translate('Specifies the priority of a user task. Must be an integer between 0 and 100. If no value is provided, the default value is 50. '), jsxRuntime.jsx("a", {
          href: "https://docs.camunda.io/docs/components/modeler/bpmn/user-tasks/#define-user-task-priority",
          target: "_blank",
          rel: "noopener noreferrer",
          title: translate('User task priority documentation'),
          children: translate('Learn more.')
        })]
      })
    });
  ...
  'group-adHocCompletion': element => {
    const translate = useService('translate');
    return jsxRuntime.jsxs("div", {
      children: [translate('Define the completion behavior of an ad-hoc subprocess. If no completion condition is set, it will be completed after all active elements have been completed. '), jsxRuntime.jsx("a", {
  ...
  'group-activeElements': element => {
    const translate = useService('translate');
    return jsxRuntime.jsxs("div", {
      children: [translate('Define a collection of elements which will be activated when the ad-hoc subprocess is reached. '), jsxRuntime.jsx("a", {
        href: "https://docs.camunda.io/docs/components/modeler/bpmn/ad-hoc/#activate-an-element",
        target: "_blank",
        rel: "noopener noreferrer",
        title: translate('Ad-hoc subprocess documentation'),
        children: translate('Learn more.')
  ...
  'messageSubscriptionCorrelationKey': element => {
    ...
    return jsxRuntime.jsx("div", {
      children: jsxRuntime.jsxs("p", {
        children: [translate('Identifier computed from the process context that is used to correlate an incoming message (e.g. '), jsxRuntime.jsx("code", {
          children: "= orderId"
        }), translate('). '), jsxRuntime.jsx("a", {
  ...
  'group-event-condition': () => {
    const translate = useService('translate');
    return jsxRuntime.jsxs("div", {
      children: [translate('Specify the condition that triggers this event. '), jsxRuntime.jsx("a", {
        href: "https://docs.camunda.io/docs/8.9/components/modeler/bpmn/conditional-events",
        target: "_blank",
        rel: "noopener noreferrer",
        title: translate('Conditional event documentation'),
        children: translate('About conditional events.')
      })]
    });
  },
  'condition': () => {
    const translate = useService('translate');
    return jsxRuntime.jsxs("div", {
      children: [translate('A FEEL expression that determines whether the event should trigger. '), jsxRuntime.jsx("a", {
        href: "https://docs.camunda.io/docs/8.9/components/modeler/bpmn/conditional-events/conditional-events/#condition-expressions-feel",
        target: "_blank",
        rel: "noopener noreferrer",
        title: translate('Conditional event documentation'),
        children: translate('Learn more.')
  ...
  'variableEvents': () => {
    const translate = useService('translate');
    return jsxRuntime.jsxs("div", {
      children: [translate('Variable events that trigger the condition evaluation. If none selected, all variable events will trigger the condition evaluation. '), jsxRuntime.jsx("a", {
        href: "https://docs.camunda.io/docs/8.9/components/modeler/bpmn/conditional-events/conditional-events/#variable-filters",
        target: "_blank",
        rel: "noopener noreferrer",
        title: translate('Conditional event documentation'),
        children: translate('Learn more.')
  ...
  'group-headers': element => {
    const translate = useService('translate');
    return jsxRuntime.jsxs("div", {
      children: [translate('Define static metadata passed to job workers alongside each job. Headers are not evaluated by the engine — use them for fixed worker configuration (e.g. '), jsxRuntime.jsx("code", {
        children: "resultVariable"
      }), translate(', '), jsxRuntime.jsx("code", {
        children: "paymentMethod"
      }), translate('). '), jsxRuntime.jsx("a", {
        href: "https://docs.camunda.io/docs/components/modeler/bpmn/service-tasks/#task-headers",
        target: "_blank",
        rel: "noopener noreferrer",
        title: translate('Task headers documentation'),
        children: translate('Learn more.')
      })]
    });
  },
  'group-Zeebe__TaskListeners': element => {
    const translate = useService('translate');
    return jsxRuntime.jsxs("div", {
      children: [translate('React to user task lifecycle events by executing a job worker. '), jsxRuntime.jsx("a", {
        href: "https://docs.camunda.io/docs/components/modeler/bpmn/user-tasks/#task-listeners",
        target: "_blank",
        rel: "noopener noreferrer",
        title: translate('Task listeners documentation'),
        children: translate('Learn more.')
      })]
    });
  },
  'group-Zeebe__ExecutionListeners': element => {
    const translate = useService('translate');
    return jsxRuntime.jsxs("div", {
      children: [translate('Add custom logic that reacts to various events in the workflow execution life-cycle. '), jsxRuntime.jsx("a", {
        href: "https://docs.camunda.io/docs/components/concepts/execution-listeners/",
        target: "_blank",
        rel: "noopener noreferrer",
        title: translate('Execution listeners documentation'),
        children: translate('Learn more.')
      })]
    });
  },
  'group-Zeebe__ExtensionProperties': element => {
    const translate = useService('translate');
    return jsxRuntime.jsx("div", {
      children: translate('Add custom key-value metadata to this element. Extension properties have no effect on process execution — they can be used to attach configuration visible for other consumers of the BPMN diagram. ')
    });
  },
  'group-script': element => {
    const translate = useService('translate');
    return jsxRuntime.jsxs("div", {
      children: [translate('Define the FEEL expression to evaluate and the variable to store the result in. '), jsxRuntime.jsx("a", {
        href: "https://docs.camunda.io/docs/components/modeler/bpmn/script-tasks/#defining-a-script-task",
        target: "_blank",
        rel: "noopener noreferrer",
        title: translate('Script task documentation'),
  ...
  'group-outputPropagation': element => {
    const translate = useService('translate');
    return jsxRuntime.jsxs("div", {
      children: [translate('Control which variables from the called process are merged back into the parent scope. By default, all child variables are propagated; use output mappings to selectively return specific variables. '), jsxRuntime.jsx("a", {
        href: "https://docs.camunda.io/docs/components/modeler/bpmn/call-activities/#variable-mappings",
        target: "_blank",
        rel: "noopener noreferrer",
        title: translate('Call activity documentation'),
        children: translate('Learn more.')
  ...
  'group-adHocSubProcessImplementation': element => {
    const translate = useService('translate');
    return jsxRuntime.jsxs("div", {
      children: [translate('Implement the ad-hoc subprocess as a job worker instead of activating inner elements. The job type determines which worker handles the subprocess execution. '), jsxRuntime.jsx("a", {
        href: "https://docs.camunda.io/docs/components/modeler/bpmn/ad-hoc/",
        target: "_blank",
        rel: "noopener noreferrer",
        title: translate('Ad-hoc subprocess documentation'),
        children: translate('Learn more.')
  ...
  'group-outputCollection': element => {
    const translate = useService('translate');
    return jsxRuntime.jsxs("div", {
      children: [translate('Define how to collect the outputs of the ad-hoc subprocess. The output collection variable stores the list of results; the output element expression defines what each element contributes. '), jsxRuntime.jsx("a", {
        href: "https://docs.camunda.io/docs/components/modeler/bpmn/ad-hoc/",
        target: "_blank",
        rel: "noopener noreferrer",
        title: translate('Ad-hoc subprocess documentation'),
...
exports.CamundaPlatformTooltipProvider = TooltipProvider;
exports.ZeebePropertiesProviderModule = index$1;
exports.ZeebeTooltipProvider = TooltipProvider$1;
