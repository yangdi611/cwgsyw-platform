...
*/
//#region virtual:ibm-cloud--internet-services/16.js
var _16_default = {
	"elem": "svg",
	"attrs": {
	...
	"content": [{
		...
		"elem": "path",
		"attrs": { "d": "M19,25H8.5c-3,0-5.5-2.5-5.5-5.5c0-2.7,1.9-4.9,4.5-5.4l1.3-0.2l0.3-1.3C9.9,8.7,13.2,6,17,6c0.5,0,1,0,1.5,0.1	c1.6,0.3,3,1.1,4.2,2.2l1.4-1.4c-1.4-1.4-3.2-2.4-5.2-2.7C18.3,4.1,17.6,4,17,4c-4.7,0-8.9,3.3-9.8,8.1C3.6,12.8,1,15.9,1,19.5	C1,23.6,4.3,27,8.5,27H19V25z" }
	}],
