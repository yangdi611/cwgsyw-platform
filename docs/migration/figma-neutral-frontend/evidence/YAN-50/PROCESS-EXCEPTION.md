...
- Risk and blast radius: analytics filter/table layout defects may ship undetected until a later authorized visual pass
- Temporary controls: isolated Neutral tokens; fail-closed token tests still run
- Follow-up task and expiry: later authorized visual pass; expires when the user re-enables visual audit
- Scope: this Goal from 2026-08-14 onward, including YAN-50 and later slices, until revoked
