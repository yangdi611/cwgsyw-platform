...
- Date: 2026-08-18.
- Exception: deliver the YAN-63 `/change-docs/new` convergence inside the user-pinned `/Users/byron/AI/worktrees/YAN-71` worktree rather than a separate YAN-63 worktree.
- Controls: page-local composition and CSS, symbol impact before edits, no API/query/RBAC/route/write changes, focused tests, browser review, and GitNexus change detection.
