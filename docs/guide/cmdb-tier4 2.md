...
> 模块：CMDB 集成联动 / CI 实例 ↔ 设备 / 变更文档 / 日报 / 告警 / IPAM
> 对应 Flyway V27–V31，Phase 4A–4F（6 个子阶段）
...
9. [前端页面与组件](#前端页面与组件)
10. [API 参考](#api-参考)
11. [权限控制（RBAC）](#权限控制rbac)
12. [审计日志](#审计日志)
13. [配置项](#配置项)
14. [已知问题与注意事项](#已知问题与注意事项)
...
1. **createModel 参数名不匹配**（`instances/page.tsx` 第 83 行，严重度: medium）
