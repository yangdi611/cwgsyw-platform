...
|---|---|---|---|---|
| `AC-001` | CMDB-005 | L1 | `test-results/<remediationRunId>/REM-P1-008/` | `NOT_RUN` |
| `AC-002` | CMDB-006 / CMDB-008 / CMDB-009 / CMDB-010 / CMDB-011 / CMDB-017 | L2 | 逐缺陷独立 result | `NOT_RUN` |
