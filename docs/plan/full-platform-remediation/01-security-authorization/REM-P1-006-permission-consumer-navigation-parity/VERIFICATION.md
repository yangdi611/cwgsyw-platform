...
|---|---|---|---|---|
| `AC-001` | RBAC-006 | L1 定向 | `test-results/<remediationRunId>/REM-P1-006/` | `NOT_RUN` |
| `AC-002` | RBAC-013 / RBAC-015 / FILE-016 / AI-004 / AUDIT-003 / BACKUP-003 / IPAM-008 | L2 根因聚类 | 同上，逐缺陷独立结果 | `NOT_RUN` |
