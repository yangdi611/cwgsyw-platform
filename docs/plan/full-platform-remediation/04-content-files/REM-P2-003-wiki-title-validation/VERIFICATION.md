...
|---|---|---|---|---|
| `AC-001` | WIKI-008 | L1 | `test-results/<remediationRunId>/REM-P2-003/` | `NOT_RUN` |
...
历史证据来自 `BUG-FQA-057` 对应章节。PASS 必须同时满足行为、持久化、权限、审计与清理；残留或未解释 5xx/Console error 为 FAIL；缺授权或精确清理能力为 BLOCKED。新证据不得覆盖旧证据。
