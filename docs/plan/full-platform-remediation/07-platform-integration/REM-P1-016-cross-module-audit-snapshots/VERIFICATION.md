...
|---|---|---|---|---|
| `AC-001` | IPAM-002 | L1 定向 | `test-results/<remediationRunId>/REM-P1-016/` | `NOT_RUN` |
| `AC-002` | IPAM-005 / IPAM-007 / IPAM-010 / CMDB-IMPORT / AUDIT-002 | L2 根因聚类 | 同上，逐缺陷独立结果 | `NOT_RUN` |
